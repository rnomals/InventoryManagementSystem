        ...
        <div class="col-md-12">
            ...
            <div class="card card-widget widget-user">
              ...
              <div class="widget-user-header bg-info-active">
                <h3 class="widget-user-username">Nmae</h3>
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <textarea class="form-control" id="inputExperience" placeholder="Experience" :class="{ 'is-invalid': form.errors.has('bio') }"></textarea>
                      ...
                      <div class="form-group">
                        ...
                        <input type="file" @change="updateProfile" class="custom-file-input" id="profileImage">
                        ...
                        <div class="form-group">
                        <label for="inputEmail" class="col-sm-6 control-label">Passsword(Leave empty if not changing)</label>
                        <div class="col-sm-10">
